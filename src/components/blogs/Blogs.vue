<template>
    <div class="flex flex-col lg:flex-row justify-between">
        <h1 class="text-3xl font-semibold mb-4">All Blogs</h1>
        <p>
    ...
    <div v-for="blog in blogs" :key="blog.id" class="shadow-md p-2 lg:p-5 flex flex-col mb-4 rounded-md border gap-1">
        <img class="h-40 w-64 border rounded-md" :src="blog.image" alt="blog image">
        ...
        <div><span class="text-lg font-semibold text-gray-600">Body:</span>
            <div v-html="blog.body"></div>
        </div>
        <div class="flex gap-3 mt-5">
            <button @click="handleDeleteBlog(blog.id)"
                class="bg-red-600 px-5 py-2 rounded-md text-white">Delete</button>
