    ...
    <div class="lg:shadow-lg lg:px-5 lg:pb-8 rounded-md">
        ...
        <form @submit.prevent="handleAddEducation">
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-5 mb-4">
                <div class="mt-4 w-full lg:w-3/6">
                ...
                <div class="lg:mt-4 w-full lg:w-1/6">
                ...
                <div class="lg:mt-4 w-full lg:w-2/6">
            ...
            <div class="mt-6">
                <button type="submit"
                    class="bg-blue-600 w-full text-white py-2 px-14 rounded-md hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-500">Save
                </button>
            </div>
        </form>
    </div>
